# -*- coding: utf-8 -*-
#
# mio documentation build configuration file, created by
...
exec(
    compile(
        open(
            path.abspath(
                path.join(path.dirname(__file__), "../../mio/version.py")),
            "r"
        ).read(),
        "../../mio/version.py", "exec"
    ),
...
project = u'mio'
copyright = u'2012-2013, James Mills'
url = "https://bitbucket.org/prologic/mio"
...
latex_documents = [
    (
        'index', 'mio.tex', u'mio Documentation',
